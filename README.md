...
Option 1.) You can run Sorting Visualizer directly from the release. Download the release and run the .exe application i.e., Sorting Visualizer.exe [Download](https://github.com/Ayushm2112/Sorting-Visualizer/blob/main/Sorting.Visualizer1.0.zip)
